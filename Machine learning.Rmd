...
Dataset is quite big, it contains 160 variables and 19622. I removed all variables that did not contained relevant data. Removed variables contained data such as averages, standart deviations and skewness measures which are not psysical readings from accelometers representing the activity. 
...
fin.data<-mplt[complete.cases(train),]
```
